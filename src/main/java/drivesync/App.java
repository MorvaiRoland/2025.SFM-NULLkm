...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        FXMLLoader loginLoader = new FXMLLoader(getClass().getResource("/drivesync/Main.fxml"));
        ...
        FXMLLoader homeLoader = new FXMLLoader(getClass().getResource("/drivesync/Home.fxml"));
